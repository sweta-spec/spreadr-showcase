...
import { ArrowRight, Zap, RefreshCw, Globe, BarChart3, Chrome, Tag, Star, Users, ShoppingBag } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              ...
              <motion.h1 variants={fadeUp} className="text-4xl md:text-5xl lg:text-6xl font-bold font-display leading-tight">
                Import Amazon Products to{" "}
                <span className="text-gradient">Shopify</span> in Minutes
              </motion.h1>
              <motion.p variants={fadeUp} className="text-lg text-muted-foreground max-w-lg">
                Start an Amazon affiliate store or launch your dropshipping business. Import, sync, and sell — no coding needed. Trusted by 10,000+ merchants.
              </motion.p>
            ...
            >
              <div className="rounded-2xl overflow-hidden card-elevated border border-border">
                <img src={heroImage} alt="Spreadr Amazon Importer" className="w-full h-auto" />
              </div>
              <div className="absolute -bottom-4 -left-4 bg-card rounded-xl p-3 card-elevated border border-border">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-shopify/10 flex items-center justify-center">
                    <Zap className="w-4 h-4 text-shopify" />
                  </div>
                  <div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Tag, title: "Markup Pricing", desc: "Set custom pricing rules and markups for your imported products. Full control over your margins." },
              ...
              { icon: BarChart3, title: "Analytics", desc: "Track clicks, conversions, and commissions with built-in analytics and Google Analytics integration." },
            ].map((feature, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">Get started in 3 simple steps</p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "01", img: featureImport, title: "Import Products", desc: "Use our 1-click importer, bulk CSV upload, or Chrome Extension to add Amazon products to your store." },
              { step: "02", img: featureSync, title: "Auto-Sync & Customize", desc: "Products auto-sync with Amazon for price and availability. Customize markup pricing, tags, and descriptions." },
              { step: "03", img: featureAffiliate, title: "Earn & Grow", desc: "Earn affiliate commissions or dropship products. Geo-localize visitors and track everything with analytics." },
            ].map((item, i) => (
              <motion.div
                key={i}
              ...
              >
                <div className="relative mb-6">
                  <div className="rounded-xl overflow-hidden card-elevated border border-border">
                    <img src={item.img} alt={item.title} className="w-full h-48 object-cover" />
                  </div>
                  <div className="absolute -top-3 -left-3 w-10 h-10 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-bold font-display text-sm">
                    {item.step}
                  </div>
                </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              { text: "Love this app. Easy transfer of link to store. A great app for beginners.", store: "Home and Clothes GO SHOP", country: "United States", rating: 5 },
              { text: "So far, so amazing. Customer service is instant and thorough. I'm happy as long as the customer service remains great.", store: "imprüv", country: "United States", rating: 5 },
              { text: "Merchants highly recommend this app for its user-friendly interface and effective affiliate integration, allowing seamless commission earnings.", store: "Shopify Community", country: "Worldwide", rating: 5 },
            ].map((review, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="max-w-2xl mx-auto">
            ...
            <motion.p variants={fadeUp} className="text-primary-foreground/80 mb-8">
              Join 10,000+ merchants already using Spreadr. Start your 7-day free trial today.
            </motion.p>
